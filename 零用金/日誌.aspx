<%@ Page Language="VB" MasterPageFile="./MasterPage.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="日誌.aspx.vb" Inherits="日誌" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script src='js/日誌.js'></script>
    <link rel="stylesheet" runat="server" media="screen" href="css\日誌.css"/>
    <style>
</style>
    <div><h1><a id="Title" href="日誌.aspx">日誌<a></h1></div>
    <asp:Panel ID="Panel1" runat="server" CssClass="Panel1" DefaultButton="搜尋">
        <asp:TextBox ID="id" runat="server" Text='' Maxlength=0 Enabled="True" DefaultButton="搜尋" CssClass="TextBox id" Visible = "False"/>
        ...
        單位別<asp:DropDownList ID="單位別" runat="server" AutoPostBack="True" CssClass="DropDownList">
            <asp:ListItem Text="" Value=""></asp:ListItem>
        ...
        承辦人<asp:DropDownList ID="承辦人" runat="server" Text='<%# Bind("承辦人") %>' AutoPostBack="True" CssClass="DropDownList">
            <asp:ListItem Text="" Value=""></asp:ListItem>
        ...
        等帳時間<asp:DropDownList ID="等帳_月1" runat="server" AutoPostBack="True" CssClass="DropDownList">
            <asp:ListItem Text="" Value=""></asp:ListItem>
            <asp:ListItem Text="1" Value="1" Selected="True"></asp:ListItem>
            <asp:ListItem Text="2" Value="2"></asp:ListItem>
            <asp:ListItem Text="3" Value="3"></asp:ListItem>
        ...
        <asp:DropDownList ID="等帳_日1" runat="server" AutoPostBack="True" CssClass="DropDownList">
            </asp:DropDownList>日~
            <asp:DropDownList ID="等帳_月2" runat="server" AutoPostBack="True" CssClass="DropDownList">
                <asp:ListItem Text="" Value=""></asp:ListItem>
                <asp:ListItem Text="1" Value="1"></asp:ListItem>
                <asp:ListItem Text="2" Value="2"></asp:ListItem>
                <asp:ListItem Text="3" Value="3"></asp:ListItem>
        ...
        <asp:DropDownList ID="等帳_日2" runat="server" AutoPostBack="True" CssClass="DropDownList">
        </asp:DropDownList>日
        <BR>
        科目<asp:DropDownList ID="科目" runat="server" AutoPostBack="True" CssClass="DropDownList">
        </asp:DropDownList>
        ...
        當前狀態<asp:DropDownList ID="審核狀態" runat="server" AutoPostBack="True" CssClass="DropDownList">
                    <asp:ListItem Text="" Value=""></asp:ListItem>
        ...
        審核動作<asp:DropDownList ID="動作" runat="server" AutoPostBack="True" CssClass="DropDownList">
            <asp:ListItem Text="" Value=""></asp:ListItem>
            <asp:ListItem Text="主計室通過" Value="主計室通過"></asp:ListItem>
            ...
            <asp:ListItem Text="駁回" Value="駁回"></asp:ListItem>
            <asp:ListItem Text="刪除" Value="刪除"></asp:ListItem>
        </asp:DropDownList>
        <asp:Button ID="清空" runat="server" Text="清空"  OnClick="Clear_Click"  CssClass="GreenButton"/>
        <asp:Button ID="搜尋" runat="server" Text="詳細搜尋" CssClass="GreenButton"/>
    ...
    <asp:Panel ID="Panel3" runat="server" CssClass="Panel3" >
        <asp:Button ID="返回主畫面" runat="server" Text="返回主畫面" OnClick="返回主畫面_Click" CssClass="GreenButton" visible="False" style="float:right"/>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CellPadding="1" HorizontalAlign="Center" DataSourceID="SqlDataSource1" DataKeyNames="id" GridLines="None" ShowHeaderWhenEmpty="false" AllowPaging="True" PageSize="20" AllowSorting="True" PagerSettings-PageButtonCount=25 EnableModelValidation="True" AutoGenerateEditButton="false" >
            <Columns>
                ...
                <asp:TemplateField HeaderText="異動日期" >
                    <ItemTemplate>
                        <asp:Label ID="日期" runat="server" Text='<%# Eval("日期") %>' Maxlength=0 Enabled="False" CssClass="Label 日期"/>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"/>
                    <ItemStyle HorizontalAlign="Center" CssClass="Item"/>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="摘要">
                    <ItemTemplate>
                        <asp:Label ID="摘要" runat="server" Text='<%# Eval("摘要") %>' Maxlength=0 Enabled="False"  CssClass="Label 摘要"/>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"/>
                    <ItemStyle HorizontalAlign="Center" CssClass="Item"/>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="姓名">
                    <ItemTemplate>
                        <asp:ImageButton ID="姓名" runat="server" ImageUrl='<%# If (Eval("姓名").ToString = "", "", Eval("姓名")) %>' AutoPostBack="False" OnClientClick="Alert('123456');return false;" Visible='<%# If (Eval("姓名").ToString = "", "False", "True") %>' CssClass="Label 姓名"/>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"/>
                    <ItemStyle HorizontalAlign="Center" CssClass="Item"/>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="商號">
                    <ItemTemplate>
                        <asp:Label ID="商號" runat="server" Text='<%# Eval("商號") %>' Maxlength=0 Enabled="False" CssClass="Label 商號"/>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"/>
                    <ItemStyle HorizontalAlign="Center" CssClass="Item"/>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="經手人">
                    <ItemTemplate>
                        <asp:ImageButton ID="經手人" runat="server" ImageUrl='<%# If (Eval("經手人").ToString = "", "", Eval("經手人")) %>' AutoPostBack="False" OnClientClick="Alert('123456');return false;" Visible='<%# If (Eval("經手人").ToString = "", "False", "True") %>' CssClass="Label 經手人"/>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"/>
                    <ItemStyle HorizontalAlign="Center" CssClass="Item"/>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="種類">
                    <ItemTemplate>
                        <asp:Label ID="種類" runat="server" Text='<%# Eval("_種類") %>' Maxlength=0 Enabled="False" CssClass="Label 種類"/>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"/>
                    <ItemStyle HorizontalAlign="Center" CssClass="Item"/>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="當前狀態">
                    ...
                    If (Eval("駁回原因").ToString = "拿回", "被拿回", "駁回"))%>' Maxlength=0 Enabled="True" CssClass="Label 審核狀態"/>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"/>
                    <ItemStyle HorizontalAlign="Center" CssClass="Item"/>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="原因" >
                    <ItemTemplate>
                        <asp:Label ID="駁回原因" runat="server" Text='<%# Eval("原因") %>' Maxlength=0 Enabled="False" CssClass="Label 駁回原因"/>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"/>
                    <ItemStyle HorizontalAlign="Center" CssClass="Item"/>
                </asp:TemplateField>
    ...
    <asp:Panel ID="Panel5" runat="server" CssClass="Panel5" Visible="False" >
     <asp:Button ID="返回2" runat="server" Text="返回"  OnClick="返回_Click" CssClass="GreenButton" />
    <table  style="border-collapse:collapse; border:1px solid black;">
    <tr >
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_1" runat="server" Text='ID' Maxlength=0 Enabled="true" CssClass="Label ID" ForeColor="White"/></th>
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_2" runat="server" Text='_種類' Maxlength=0 Enabled="true" CssClass="Label _種類" ForeColor="White"/></th>
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="100"><asp:Label ID="Label3_3" runat="server" Text='單位別' Maxlength=0 Enabled="true" CssClass="Label 單位別" ForeColor="White"/></th>
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="100"><asp:Label ID="Label3_4" runat="server" Text='承辦人' Maxlength=0 Enabled="true" CssClass="Label 承辦人" ForeColor="White"/></th>
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_5" runat="server" Text='年' Maxlength=0 Enabled="true" CssClass="Label " ForeColor="White"/></th>
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_6" runat="server" Text='月' Maxlength=0 Enabled="true" CssClass="Label 月" ForeColor="White"/></th>
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_7" runat="server" Text='日' Maxlength=0 Enabled="true" CssClass="Label 日" ForeColor="White"/></th>
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="200"><asp:Label ID="Label3_8" runat="server" Text='科目' Maxlength=0 Enabled="true" CssClass="Label 科目" ForeColor="White"/></th> 
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_9" runat="server" Text='摘要' Maxlength=0 Enabled="true" CssClass="Label 摘要" ForeColor="White"/></th> 
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="100"><asp:Label ID="Label3_10" runat="server" Text='姓名' Maxlength=0 Enabled="true" CssClass="Label 姓名" ForeColor="White"/></th> 
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_11" runat="server" Text='商號' Maxlength=0 Enabled="true" CssClass="Label 商號" ForeColor="White"/></th> 
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="100"><asp:Label ID="Label3_12" runat="server" Text='經手人' Maxlength=0 Enabled="true" CssClass="Label 經手人" ForeColor="White"/></th> 
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_13" runat="server" Text='種類' Maxlength=0 Enabled="true" CssClass="Label 種類" ForeColor="White"/></th> 
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_14" runat="server" Text='號數' Maxlength=0 Enabled="true" CssClass="Label 號數" ForeColor="White"/></th> 
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_15" runat="server" Text='收入' Maxlength=0 Enabled="true" CssClass="Label 收入" ForeColor="White"/></th> 
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_16" runat="server" Text='支出' Maxlength=0 Enabled="true" CssClass="Label 支出" ForeColor="White"/></th> 
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="50"><asp:Label ID="Label3_17" runat="server" Text='備註' Maxlength=0 Enabled="true" CssClass="Label 備註" ForeColor="White"/></th> 
        <th style="border:1px solid black;" bgcolor="Green" align='center' width="250"><asp:Label ID="Label3_18" runat="server" Text='刪除日期' Maxlength=0 Enabled="true" CssClass="Label" ForeColor="White"/></th>
    </tr>
    <tr>
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_id" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label ID"/></td>
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D__種類" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label _種類"/></td> 
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="100"><asp:Label ID="D_單位別" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 單位別"/></td>
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="100"><asp:Label ID="D_承辦人" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 承辦人"/></td>
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_年" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label"/></td> 
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_月" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 月"/></td> 
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_日" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 日"/></td>
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="200"><asp:Label ID="D_科目" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 科目"/></td> 
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_摘要" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 摘要"/></td> 
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="100"><asp:Image ID="D_姓名" runat="server" Enabled="true" CssClass="Label 姓名"/></td>
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_商號" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 商號"/></td> 
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="100"><asp:Image ID="D_經手人" runat="server" Enabled="true" CssClass="Label 經手人"/></td> 
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_種類" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 種類"/></td>
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_號數" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 號數"/></td> 
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_收入" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 收入"/></td> 
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_支出" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 支出"/></td>
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="50"><asp:Label ID="D_備註" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label 備註"/></td> 
        <td style="border:1px solid black;" bgcolor=#F0F0F0 align='center' width="250"><asp:Label ID="D_刪除日期" runat="server" Text='' Maxlength=0 Enabled="true" CssClass="Label"/></td>
    </tr>
    </table>
    </asp:Panel>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:ApplicationServices%>'
        SelectCommand="
            SELECT * FROM 日誌,收支備查簿
            WHERE 日誌.id=收支備查簿.id
            AND (''=TRIM(@id) OR 收支備查簿.id LIKE N'%'+TRIM(@id)+'%')
            AND 取號 = 0
            AND (''=TRIM(@_種類) OR _種類 = @_種類)
            AND (TRIM(@年)='' OR (日期2 BETWEEN 
                CONVERT(date,STR(TRIM(@年)+1911)+STR(ISNULL(NULLIF(TRIM(@月1),''),'1'))+STR(ISNULL(NULLIF(TRIM(@日1),''),'1')))
                AND DATEADD(day, 1,CONVERT(date,STR(@年+1911)+STR(ISNULL(NULLIF(TRIM(@月2),''),'12'))+STR(ISNULL(NULLIF(TRIM(@日2),''),STR(Day(EOMONTH(STR(TRIM(@年)+1911)+'/'+STR(ISNULL(NULLIF(TRIM(@月2),''),'12'))+'/01')))))))))
            AND (''=TRIM(@單位別) OR 單位別 LIKE N'%'+TRIM(@單位別)+'%')
            And (''=TRIM(@承辦人) OR 承辦人 LIKE N'%'+TRIM(@承辦人)+'%')
            AND (TRIM(@年)='' OR (CONVERT(date,STR(年+1911)+STR(月)+STR(日)) 
                BETWEEN CONVERT(date,STR(TRIM(@年)+1911)+STR(ISNULL(NULLIF(TRIM(@等帳_月1),''),'1'))+STR(ISNULL(NULLIF(TRIM(@等帳_日1),''),'1')))
                AND CONVERT(date,STR(@年+1911)+STR(ISNULL(NULLIF(TRIM(@等帳_月2),''),'12'))+STR(ISNULL(NULLIF(TRIM(@等帳_日2),''),STR(Day(EOMONTH(STR(TRIM(@年)+1911)+'/'+STR(ISNULL(NULLIF(TRIM(@等帳_月2),''),'12'))+'/01')))))))
                OR (Not(''=TRIM(@單位別)) OR Not(''=TRIM(@承辦人)) OR Not(''=TRIM(@科目)) OR Not(''=TRIM(@摘要)) OR Not(''=TRIM(@商號)) OR Not(''=TRIM(@號數1)) OR Not(''=TRIM(@號數2)) OR Not(''=TRIM(@審核狀態))
                    OR Not(''=TRIM(@動作)) OR Not(''=TRIM(@月1)) OR Not(''=TRIM(@日1)) OR Not(''=TRIM(@月2)) OR Not(''=TRIM(@日2))) 
			        AND (TRIM(@等帳_月1)='' OR TRIM(@等帳_日1)='' OR TRIM(@等帳_月2)='' OR TRIM(@等帳_日2)=''))
            ...
            AND (''=TRIM(@審核狀態) OR
            IIf (鎖定='True', IIf (過審='True', IIf (回覆 = 'True', '主計室通過', IIf (送交主計室日期 IS NULL, '通過', '送交主計室')), '已送審'),IIf (駁回原因='拿回', '被拿回', '駁回')) LIKE TRIM(@審核狀態))
            AND (''=TRIM(@動作) OR 日誌.動作 LIKE N''+TRIM(@動作)+'%')
            ORDER BY 日期2 desc"
        Insertcommand="" 
        UpdateCommand=""
        DeleteCommand="">
        <%--因為原資料用DateTime，所以收尋結尾日期要+1,Dateadd--%>
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="等帳_月1" ConvertEmptyStringToNull="False" Name="等帳_月1" PropertyName="Text" Type="String"/>
            <asp:ControlParameter ControlID="等帳_日1" ConvertEmptyStringToNull="False" Name="等帳_日1" PropertyName="Text" Type="String"/>
            <asp:ControlParameter ControlID="等帳_月2" ConvertEmptyStringToNull="False" Name="等帳_月2" PropertyName="Text" Type="String"/>
            <asp:ControlParameter ControlID="等帳_日2" ConvertEmptyStringToNull="False" Name="等帳_日2" PropertyName="Text" Type="String"/>
