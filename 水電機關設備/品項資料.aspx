<%@ Page Language="VB" MasterPageFile="./MasterPage.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="品項資料.aspx.vb" Inherits="品項資料"%>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    ...
    <script src='js/品項資料.js'></script>
    <link rel="stylesheet" runat="server" media="screen" href="css\品項資料.css"/>
    <style>
    </style>
    <div><h1><a id="Title" href="品項資料.aspx">設備資料<a></h1></div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CellPadding="1" HorizontalAlign="Center" DataSourceID="SqlDataSource1" DataKeyNames="id" GridLines="None" ShowHeaderWhenEmpty="false" AllowPaging="True" PageSize="15" AllowSorting="True" PagerSettings-PageButtonCount=25 EnableModelValidation="True" AutoGenerateEditButton="false">
            <Columns>
                ...
                <asp:TemplateField HeaderText="品項">
                    <ItemTemplate>
                    <asp:TextBox ID="品項" runat="server" Text='<%# Bind("品項") %>' Maxlength=0 Enabled="True" CssClass="TextBox 品項"/>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"/>
                    <ItemStyle HorizontalAlign="Center" CssClass="Item"/>
                </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:ApplicationServices%>'
        SelectCommand="
            ...
            Where id <> 19
            ORDER BY id"
        Insertcommand="INSERT INTO 品項資料表 (品項) VALUES ('')"
        UpdateCommand=""
        DeleteCommand="">
        <SelectParameters>
        </SelectParameters>
